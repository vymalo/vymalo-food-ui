...
export function ProductVariant() {
	...
	return (
		<div className="flex flex-col gap-y-4 md:gap-y-4 max-sm:rounded-t-2xl max-sm:border-t-2 max-sm:fixed max-sm:p-4 max-sm:z-10 max-sm:bottom-0 max-sm:left-0 max-sm:right-0 max-sm:bg-base-200">
			...
			<div className='flex flex-row gap-2 md:flex-col'>
				...
				<Link to="/checkout" className='basis-1/2 btn btn-ghost btn-outline'>
					<span>Checkout</span>
					<ShoppingBag />
				</Link>
			</div>

  ...
  return (
    <div>
      ...
      <Collapse
        ...
        open={step === 0}
        title='Contact info'>
        <CheckoutUserInfo onDone={goNext} />
      </Collapse>
      ...
      <Collapse
        ...
        <CheckoutShippingAddress goBack={goBack} onDone={goNext} />
      </Collapse>
      ...
      <Collapse
        ...
        <CheckoutUserShipment goBack={goBack} onDone={goNext} />
      </Collapse>
      ...
      <Collapse
        ...
        <p>hello</p>
        <button
          className='btn btn-outline btn-primary max-md:btn-block'
          type='button'
          onClick={goBack}>
          <span>Back</span>
          <ArrowUp />
